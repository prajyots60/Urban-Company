...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Book Handyman', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
//         centerTitle: true,
//         elevation: 0,
...
//           elevation: 4,
//         ),
//         child: const Text('Confirm Booking', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
//       ),
//     );
//   }
